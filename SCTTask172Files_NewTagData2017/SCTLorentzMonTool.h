...
private:
  ...
  Prof_t m_phiVsNstrips_075[4];
  Prof_t m_phiVsNstrips_15[4];
  Prof_t m_phiVsNstrips_more15[4];
  ...
  //// 1 dimensional plots for cluster width
  H1_t h_Nstrips[4];
  H1_t h_Nstrips_075[4];
  H1_t h_Nstrips_15[4];
  H1_t h_Nstrips_more15[4];
  H1_t h_Nstrips_phiMinus5Degree[4];
  H1_t h_Nstrips_075_phiMinus5Degree[4];
  H1_t h_Nstrips_15_phiMinus5Degree[4];
  H1_t h_Nstrips_more15_phiMinus5Degree[4];
  H1_t h_Nstrips_100[4];
  H1_t h_Nstrips_111[4];
  H1_t h_Nstrips_Side[4][2];
  H1_t h_Nstrips_Side_100[4][2];
  H1_t h_Nstrips_Side_111[4][2];
  
  H1_t h_NstripsEC[9];
  H1_t h_NstripsECSideA[9];
  H1_t h_NstripsECSideC[9];
  
  H1_t h_NstripsECOuter;
  H1_t h_NstripsECMiddle;
  H1_t h_NstripsECInner;
  H1_t h_ModuleOuter;
  H1_t h_ModuleMiddle;
  H1_t h_ModuleInner;
  
  
  H1_t h_NstripsECSideAOuter;
  H1_t h_NstripsECSideAMiddle;
  H1_t h_NstripsECSideAInner;
  
  H1_t h_NstripsECSideCOuter;
  H1_t h_NstripsECSideCMiddle;
  H1_t h_NstripsECSideCInner;
...
//   bool chooseModule(bool lowInVd0, const int eta, const int phi);
  ...
  H1_t h1MyFactory(const std::string & name, const std::string & title, int nbinsx, float xlow, float xhigh, MonGroup & registry, int& iflag);
  //@}
};
