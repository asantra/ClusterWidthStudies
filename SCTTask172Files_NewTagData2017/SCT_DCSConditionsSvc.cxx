...
/// modified by Arka Santra (arka.santra@cern.ch) 
...
m_chanstatCut("NORM"), // needed for non 50V data, by Arka Santra
//m_chanstatCut("NSTBY"), // needed for 50V data, by Arka Santra
m_useHV(false),
m_useHVLowLimit(19.),
