            ...
            if (perigee) {
              ...
              if (passesCuts) {
                ...
                if(bec==-2 || bec==2){
                   ...
                   if(bec==-2)h_NstripsECSideC[layer]->Fill(nStrip);
                   if(bec==2)h_NstripsECSideA[layer]->Fill(nStrip);
                }
                ...
                //std::cout << "Arka " << event_number << " " << trkp->momentum().perp() << " " << trkp->eta() << " " << trackPhi << " " << phiToWafer << " " << nStrip << " " << bec << " " << layer << " " << eta << " " << phi << " " << side << " " << trkp->charge() << std::endl;
...
SCTLorentzMonTool::bookLorentzHistos() {                                                                                                                //
  ...
  for (int l = 0; l != nLayers; ++l) {
    ...
    h_Nstrips[l]  = h1MyFactory("h_Nstrips_"+hNum[l], "1D cluster width for layer "+hNum[l], 40, 0.0, 40.0, Lorentz, iflag);
    h_Nstrips[l]->GetXaxis()->SetTitle("Num of Strips");
    h_Nstrips[l]->GetYaxis()->SetTitle("events");
    
    h_Nstrips_075[l]  = h1MyFactory("h_Nstrips_075_"+hNum[l], "1D cluster width for layer "+hNum[l], 40, 0.0, 40.0, Lorentz, iflag);
    h_Nstrips_075[l]->GetXaxis()->SetTitle("Num of Strips");
    h_Nstrips_075[l]->GetYaxis()->SetTitle("events");
    
    
    h_Nstrips_15[l]  = h1MyFactory("h_Nstrips_15_"+hNum[l], "1D cluster width for layer "+hNum[l], 40, 0.0, 40.0, Lorentz, iflag);
    h_Nstrips_15[l]->GetXaxis()->SetTitle("Num of Strips");
    h_Nstrips_15[l]->GetYaxis()->SetTitle("events");
    
    h_Nstrips_more15[l]  = h1MyFactory("h_Nstrips_more15_"+hNum[l], "1D cluster width for layer "+hNum[l], 40, 0.0, 40.0, Lorentz, iflag);
    h_Nstrips_more15[l]->GetXaxis()->SetTitle("Num of Strips");
    h_Nstrips_more15[l]->GetYaxis()->SetTitle("events");
    
    
    h_Nstrips_100[l]  = h1MyFactory("h_Nstrips_100_"+hNum[l], "1D cluster width for layer "+hNum[l], 40, 0.0, 40.0, Lorentz, iflag);
    h_Nstrips_100[l]->GetXaxis()->SetTitle("Num of Strips");
    h_Nstrips_100[l]->GetYaxis()->SetTitle("events");
    
    
    h_Nstrips_111[l]  = h1MyFactory("h_Nstrips_111_"+hNum[l], "1D cluster width for layer "+hNum[l], 40, 0.0, 40.0, Lorentz, iflag);
    ...
    for (int side = 0; side < nSides; ++side) {
      ...
      /// 1 dimensional plots
      h_Nstrips_Side[l][side] = h1MyFactory("h_Nstrips_"+hNum[l] + "Side" + hNumS[side], "1D cluster width for layer "+hNum[l]+hNumS[side], 40, 0.0, 40.0, Lorentz, iflag);
      h_Nstrips_Side[l][side]->GetXaxis()->SetTitle("Num of strips");
      h_Nstrips_Side[l][side]->GetYaxis()->SetTitle("events");
      
      h_Nstrips_Side_100[l][side] = h1MyFactory("h_Nstrips_100_"+hNum[l] + "Side" + hNumS[side], "100 - 1D cluster width for layer "+hNum[l]+hNumS[side], 40, 0.0, 40.0, Lorentz, iflag);
      h_Nstrips_Side_100[l][side]->GetXaxis()->SetTitle("Num of strips");
      h_Nstrips_Side_100[l][side]->GetYaxis()->SetTitle("events");
      
      h_Nstrips_Side_111[l][side] = h1MyFactory("h_Nstrips_111_"+hNum[l] + "Side" + hNumS[side], "111 - 1D cluster width for layer "+hNum[l]+hNumS[side], 40, 0.0, 40.0, Lorentz, iflag);
  ...
  for (int l = 0; l != nECLayers; ++l) {
      ...
      h_NstripsEC[l]  = h1MyFactory("h_NstripsEC_"+hNumEC[l], "1D cluster width for layer "+hNumEC[l], 40, 0.0, 40.0, Lorentz, iflag);
      h_NstripsEC[l]->GetXaxis()->SetTitle("Num of Strips");
      h_NstripsEC[l]->GetYaxis()->SetTitle("events");
      
      h_NstripsECSideA[l]  = h1MyFactory("h_NstripsECSideA_"+hNumEC[l], "1D cluster width for layer "+hNumEC[l], 40, 0.0, 40.0, Lorentz, iflag);
      h_NstripsECSideA[l]->GetXaxis()->SetTitle("Num of Strips");
      h_NstripsECSideA[l]->GetYaxis()->SetTitle("events");
      
      h_NstripsECSideC[l]  = h1MyFactory("h_NstripsECSideC_"+hNumEC[l], "1D cluster width for layer "+hNumEC[l], 40, 0.0, 40.0, Lorentz, iflag);
